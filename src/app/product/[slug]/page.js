...
export default function ProductDetailPage({ params }) {
  ...
  return (
    <div className="min-h-screen text-gray-800 font-sans selection:bg-gray-200 selection:text-black">
          ...
          <div className="lg:col-span-5 space-y-6 md:space-y-8 pt-2">
            ...
            <div className="space-y-3 pt-2">
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="flex items-center bg-white rounded-2xl border border-gray-100 w-full sm:w-32 justify-between p-1 shadow-sm">
                  <button onClick={() => setQuantity(Math.max(1, quantity - 1))} className="w-10 h-10 flex items-center justify-center text-gray-500 hover:bg-gray-50 rounded-xl transition-all">
                    <Minus size={16} />
                  </button>
                  <span className="font-black text-sm text-gray-900">{quantity}</span>
                  <button onClick={() => setQuantity(prev => prev < product.qty ? prev + 1 : prev)} className="w-10 h-10 flex items-center justify-center text-gray-500 hover:bg-gray-50 rounded-xl transition-all">
                    <Plus size={16} />
                  </button>
                </div>
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="space-y-6">
                {reviews.length > 0 ? reviews.map((r) => (
                  <div key={r.id} className="bg-white p-6 md:p-8 rounded-[2rem] border border-gray-50 shadow-sm">
                    <div className="flex justify-between items-start mb-6">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-full bg-black flex items-center justify-center font-bold text-white text-xs uppercase">
                          {r.user?.charAt(0)}
                        </div>
                        <div>
                    ...
                    <p className="text-gray-600 leading-tight italic font-medium text-lg">"{r.comment}"</p>
                  </div>
                )) : (
